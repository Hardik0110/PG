...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-[10.5px] font-bold uppercase tracking-[0.1em] text-sidebar-foreground/50 outline-none ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div
      ...
      {...props}
    >
      {showIcon && <div className="size-4 rounded-md bg-sidebar-accent animate-pulse" />}
      <div
        className="h-4 flex-1 max-w-[--skeleton-width] bg-sidebar-accent rounded-md animate-pulse"
