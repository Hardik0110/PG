            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  height: 28,
                  borderRadius: '9999px',
                  background: settings.darkMode ? '#1C6C41' : 'var(--color-background)',
                  border: settings.darkMode ? 'none' : '1px solid var(--color-border)',
                  cursor: 'pointer',
                  position: 'relative',
              ...
              >
                <div style={{
                  ...
                  position: 'absolute',
                  top: 3,
                  left: settings.darkMode ? 26 : 4,
                  transition: 'left 150ms ease',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center'
                }}>
                  {settings.darkMode ? <Moon size={12} color='#10B981' /> : <Sun size={12} color='#F59E0B' />}
                </div>
              </button>
            </div>

            <div>
              <div style={{ fontSize: '14px', fontWeight: 500, color: 'var(--color-foreground)', marginBottom: '3px' }}>
                Accent Color
              </div>
                ...
                {['#10B981', '#3B82F6', '#8B5CF6', '#F59E0B', '#EF4444'].map((color) => (
                  <button
                    ...
                    style={{
                      ...
                      background: color,
                      border: settings.themeColor === color ? '3px solid var(--color-foreground)' : '2px solid transparent',
                      cursor: 'pointer',
